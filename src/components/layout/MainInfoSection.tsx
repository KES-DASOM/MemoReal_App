...
export function MainInfoSection({ children, title, description1, description2 }: MainInfoSetionProps) {
  return (
    <View className="mx-7 flex mb-[250px]">
      <Text className="font-bold text-[30px] mb-4">{title}</Text>
      <View className="mb-4">
        <Text className="text-[#5E5E5E]">{description1}</Text>
        <Text className="text-[#5E5E5E]">{description2}</Text>
      </View>
...
export function MainInfoSection1({ title, description1, description2 }: MainInfoSection1Props) {
  return (
    <View className="mb-4">
      <Text className="font-bold text-[18px] mb-2">{title}</Text>
      <Text className="text-[12px] text-[#5E5E5E]">{description1}</Text>
      <Text className="text-[12px] text-[#5E5E5E]">{description2}</Text>
    </View>
  );
}
  ...
  return(
    <View className="mb-4 flex-row items-center">
      <View className="bg-[#60227C] px-2 py-1 rounded-xl mr-4">
        <Text className="font-bold text-[16px] text-white">{step}</Text>
      </View>
      {children}
    </View>
  );
...
export function ColoredText({ children, color = '#60227C', className, ...rest }: ColoredTextProps) {
  ...
  return (
    <Text className={combinedClassName} {...rest}>
      {children}
    </Text>
  );
}
